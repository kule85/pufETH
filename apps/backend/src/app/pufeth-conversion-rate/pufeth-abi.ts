export const pufethAbi = [
	...
	},
	{
		inputs: [],
		name: 'PUFFER_ORACLE',
		outputs: [{ internalType: 'contract IPufferOracle', name: '', type: 'address' }],
		stateMutability: 'view',
		type: 'function',
	},
	{
	...
	{
		inputs: [{ internalType: 'uint256', name: 'sharesToWithdraw', type: 'uint256' }],
	...
	{
		inputs: [{ internalType: 'uint256', name: 'rewardsAmount', type: 'uint256' }],
		name: 'mintRewards',
		outputs: [
